# File: app.py
# Description: Simple Messaging Service API using Flask and SQLAlchemy
# GitHub: https://github.com/xnoto/messaging-service/app/app.py
# Author:
#                                   _|
...
def get_or_create_conversation(from_addr, to_addr):
    conv = Conversation.query.filter(
        or_(
            (Conversation.participant_a == from_addr)
            & (Conversation.participant_b == to_addr),
            (Conversation.participant_a == to_addr)
            & (Conversation.participant_b == from_addr),
        )
    ).first()
    if not conv:
